...
root_folders = ['Hannum']
datasetname = 'Dataset036_DataAugFAIPandLV'
                        ...
                        if quality_data['Image Quality'].str.contains('Good Image').sum() == 3:
                            ...
                            for i in range(1, 4):  # mask_001.nii to mask_003.nii and image_001.nii to image_003.nii
                                ...
                                if os.path.exists(mask_file) and os.path.exists(avg_image_file) and os.path.exists(mean_diff_file) and os.path.exists(eigenvector_file):
                                    ...
                                    image_data_list = [avg_image_data, mean_diff_data, combined_eigenvector_data, FA_image_data]
                                    ...
                                    for degree, rotated_images, rotated_mask in rotated_data:
                                        ...
                                        common_name_id_rotated = f'{root_folder}_{volunteer_folder}_{divo_folder}_r{degree}_slice__00{i}'
