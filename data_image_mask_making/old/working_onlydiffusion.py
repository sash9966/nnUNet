...
root_folders = ['Le']
output_mask_folder = f'{pwd}/all_cropped_masks'
output_image_folder = f'{pwd}/all_cropped_images'
inspection_folder = f'{pwd}/inspection'
                    ...
                    if os.path.exists(excel_path):
                        ...
                        if quality_data['Image Quality'].str.contains('Good Image').sum() == 3:
                            ...
                            for i in range(1, 4):  # mask_001.nii to mask_003.nii and image_001.nii to image_003.nii
                                ...
                                image_file = os.path.join(image_folder, f'Cropped_Average_Diffusion_Weighted_Image_Slice_00{i}.nii')
                                ...
                                if os.path.exists(mask_file) and os.path.exists(image_file):
                                    ...
                                    # Save the individual mask and image slices
                                    ...
                                    nib.save(nib.Nifti1Image(mask_slice, mask_img.affine), mask_output_filename)
                                    ...
                                    save_inspection_plots(image_data, mask_slice, common_name_id)
                                else:
